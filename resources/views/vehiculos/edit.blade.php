                            ...
                            <center>
                                <div class="container" style="display: flex; gap: 10%;">
                                    <div class="w-full">
                                        ...
                                        <input type="text" name="marca" style="background-color: transparent; width:100%; border-radius:8px;" value="{{ old('marca', $vehiculo->marca) }}" required><br><br>

                                        <label for="modelo">Modelo:</label>
                                        <input type="text" name="modelo" style="background-color: transparent; width:100%; border-radius:8px;" value="{{ old('modelo', $vehiculo->modelo) }}" required><br><br>
                                        ...
                                        <input type="text" name="ano_creacion" style="background-color: transparent; width:100%; border-radius:8px;"
                                            ...
                                            maxlength="4" value="{{ old('ano_creacion', $vehiculo->ano_creacion) }}" required><br><br>
                                    </div>

                                    <div class="w-full">
                                        <label for="color">Color:</label>
                                        <input type="text" name="color" style="background-color: transparent; width:100%; border-radius:8px;" value="{{ old('color', $vehiculo->color) }}"><br><br>
                                        ...
                                        <select name="gama_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                            ...
                                            <option value="{{ $gama->id }}" {{ old('gama_id', $vehiculo->gama_id) == $gama->id ? 'selected' : '' }}>
                                                {{ $gama->gama }}
                                            </option>
                                            @endforeach
                                        </select><br><br>
                                ...
                                <x-primary-button class="w-full px-6 py-3 inline-flex items-center justify-center"
                                    style="font-weight: 600;">{{ __('Save Edit') }}
                                </x-primary-button>
                            </center>
                        </form>
                    </div>
