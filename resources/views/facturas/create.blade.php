                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('facturas.store') }}" method="POST">
                            ...
                            <div class="detalle" style="display:flex; gap:8px;">
                                <div style="width: 30%;">
                                    ...
                                    <select name="vehiculo_id[]" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        ...
                                        <option value="{{ $vehiculo->id }}">{{ $vehiculo->marca ." ". $vehiculo->modelo ." ". $vehiculo->ano_creacion }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="date" name="fecha_inicio[]" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required />
                                </div>
                                <div>
                        ...
                        <div>
                            ...
                            <p name="total" style="font-weight: bold; font-size:15px"></p>
                        </div>
                        <div class="btn-add">
                        ...
                        <x-primary-button class="w-1/4 mt-1 px-6 py-3 inline-flex items-center justify-center"
